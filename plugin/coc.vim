...
function! s:Enable(initialize)
  ...
  augroup coc_nvim
    ...
    autocmd CursorMoved         * call s:Autocmd('CursorMoved', +expand('<abuf>'), [line('.'), col('.'), getline('.')])
    autocmd CursorMovedI        * call s:Autocmd('CursorMovedI', +expand('<abuf>'), [line('.'), col('.'), getline('.')])
