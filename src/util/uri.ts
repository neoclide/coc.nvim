...
export default class URI implements UriComponents {
  ...
  public static revive(data: UriComponents | any): URI {
    if (!data) {
      return data
      ...
      result._fsPath = (data as UriState).fsPath
...
class _URI extends URI { // tslint:disable-line
  public _formatted: string = null
  public _fsPath: string = null
