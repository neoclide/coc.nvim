...
describe('matchScore', () => {
  ...
  it('should match first letter', () => {
    ...
    expect(score('_foo_Bar', 'b')).toBe(1)
    expect(score('_foo_Bar', 'f')).toBe(2.5)
    expect(score('bar', 'a')).toBe(0.5)
  ...
  it('should match follow letters', () => {
    ...
    expect(score('adB', 'ab')).toBe(5.5)
    expect(score('adCB', 'ab')).toBe(5.05)
    expect(score('a_b_c', 'ab')).toBe(6)
    expect(score('FooBar', 'fb')).toBe(1.5)
    expect(score('FBar', 'fb')).toBe(1.5)
    expect(score('FooBar', 'FB')).toBe(6)
    expect(score('FBar', 'FB')).toBe(6)
    expect(score('a__b', 'a__b')).toBe(8.2)
    expect(score('aBc', 'ab')).toBe(5.5)
    expect(score('a_B_c', 'ab')).toBe(5.5)
    expect(score('abc', 'abc')).toBe(7.2)
    expect(score('abc', 'ac')).toBe(5.1)
    expect(score('abC', 'ac')).toBe(5.5)
  ...
  it('should only allow search once', () => {
    ...
    expect(score('foobaRow', 'fbr')).toBe(5.6)
