...
import { addDocumentation, fixIndent, getDetail, getUltisnipOption } from '../../completion/source-language'
import { CompleteOption, DurationCompleteItem, ItemDefaults } from '../../completion/types'
