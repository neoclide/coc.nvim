...
describe('funcs', () => {
  ...
  it('should use Segmenter', () => {
    ...
    if (typeof fn === 'function') {
      let descriptor = Object.getOwnPropertyDescriptor(Intl, 'Segmenter')
  ...
  it('should reuse cached segmenter per locale', (t) => {
    let fn = Intl['Segmenter']
    if (typeof fn !== 'function') return
    let spy = t.mock.method(Intl, 'Segmenter', function (this: unknown, locales?: Intl.LocalesArgument, options?: Intl.SegmenterOptions) {
