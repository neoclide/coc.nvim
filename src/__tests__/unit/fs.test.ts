...
describe('fs', () => {
  ...
  it('should check directory', () => {
    ...
    assert.strictEqual(isDirectory(__filename), false)
  ...
  describe('getFileType()', () => {
    it('should get filetype', async (t) => {
      ...
      let spy = t.mock.method(fs.promises, 'lstat', () => Promise.resolve({
        isFile: () => false,
        isDirectory: () => false,
  ...
  describe('resolveRoot', () => {
    it('resolve root consider root path', () => {
      ...
      assert.ok((res).includes('coc.nvim'))
    })
  ...
  describe('findUp', () => {
    ...
    it('findUp by filename', () => {
      ...
      assert.ok((filepath).includes('coc.nvim'))
