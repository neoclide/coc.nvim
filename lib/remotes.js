                            ...
                            if (nativeNames.indexOf(name) !== -1) {
                                ...
                                try {
                                    ...
                                    if (isCheck) {
                                        ...
                                        yield index_1.echoErr(nvim, `Vim error from ${name} source: ${e.message}`);
                                    }
                                    continue;
                                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (isCheck) {
                    ...
                    yield index_1.echoErr(nvim, `Vim error on init from source ${name}: ${e.message}`);
                }
                return null;
            }
            let optionalFns = yield this.getOptionalFns(nvim, name);
            let source = new source_vim_1.default(nvim, Object.assign({}, config, { name, optionalFns }));
            return source;
        });
    }
    getSource(nvim, name) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let remote = this.list.find(o => o.name == name);
            if (!remote) {
                yield index_1.echoErr(nvim, `Remote source ${name} not found`);
                return null;
            }
            if (remote.instance)
