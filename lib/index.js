...
let CompletePlugin = class CompletePlugin {
    ...
    onInit() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let buf of bufs) {
                    yield workspace_1.default.addBuffer(buf);
                }
    ...
    cocBufUnload(args) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield workspace_1.default.removeBuffer(bufnr);
    ...
    cocStart(args) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield workspace_1.default.addBuffer(bufnr);
    ...
    cocTextChangedI(args) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (shouldStart) {
                ...
                let opt = Object.assign({}, completes_1.default.option, {
                    input: input.search
                });
