...
let CompletePlugin = class CompletePlugin {
            ...
            complete.doComplete(sources).then(([startcol, items]) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (items.length > 1) {
                    ...
                    if (visible == 1) {
                        ...
                        if (lnum != linenr)
                            return;
                        let word = yield nvim.call('coc#util#get_insertedword', [col, len]);
                        if (word == firstWord) {
                            let input = new input_1.default(nvim, lnum, opt.input, word, opt.col);
                            increment_1.default.input = input;
                            input.highlight();
    ...
    cocTextChangeI() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!complete)
                return;
            let shouldStart = yield increment_1.default.onTextChangeI(nvim);
            if (shouldStart) {
                ...
                if (!results || results.length == 0) {
                    yield increment_1.default.stop(nvim);
                    return;
                }
                let start = Date.now();
...
], CompletePlugin.prototype, "cocDone", null);
tslib_1.__decorate([
    neovim_1.Autocmd('InsertLeave', {
        pattern: '*',
        sync: true,
    })
], CompletePlugin.prototype, "cocLeave", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    neovim_1.Function('CocSourceConfig', { sync: false })
], CompletePlugin.prototype, "cocSourceConfig", null);
tslib_1.__decorate([
