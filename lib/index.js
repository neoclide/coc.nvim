...
let CompletePlugin = class CompletePlugin {
    ...
    cocStart(args) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            complete.doComplete(sources).then(([startcol, items]) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (!autoComplete) {
                    yield increment.start(opt, items.length > 1);
                }
                ...
                completes_1.default.calculateChars();
    ...
    cocCompleteDone() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (increment.activted) {
                yield increment.onCompleteDone(item, isCoc);
            }
            if (item && isCoc) {
    ...
    cocTextChangeP() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.increment.onTextChangedP();
        });
    }
    cocTextChangedI() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
tslib_1.__decorate([
    neovim_1.Autocmd('TextChangedP', {
        pattern: '*',
        sync: true
    })
], CompletePlugin.prototype, "cocTextChangeP", null);
tslib_1.__decorate([
